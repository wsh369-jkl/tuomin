"""One-shot PDF normalization worker for high_quality_lowmem PDF inputs."""
...
from app.services.pdf_normalization_service import PdfNormalizationError, PdfNormalizationService
...
def _run(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    service = PdfNormalizationService()
...
def main() -> int:
    if len(sys.argv) != 3:
        print("usage: python -m app.workers.pdf_normalize_worker INPUT_JSON OUTPUT_JSON", file=sys.stderr)
        return 2
